package de.mariocst.editsigns.formutils.custom;

import cn.nukkit.Player;
import cn.nukkit.form.element.Element;
import cn.nukkit.form.response.FormResponseCustom;
import cn.nukkit.form.window.FormWindowCustom;
import de.mariocst.editsigns.EditSigns;
import de.mariocst.editsigns.formutils.FormHandler;
...
public class CustomForm {
    ...
    public CustomForm(EditSigns plugin, Builder b) {
        this.plugin = plugin;
        this.title = b.title;
    ...
    public static class Builder {
        ...
        public Builder(EditSigns plugin, String title) {
            this.plugin = plugin;
            this.title = title;
        }
